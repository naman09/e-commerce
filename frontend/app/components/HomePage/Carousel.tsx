  ...
  return (
    <div className="relative mx-80 overflow-hidden rounded-2xl my-2">
      ...
      <button
        ...
        className="absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 text-white px-3 py-1 rounded text-7xl"
      >
        ‹
      </button>
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 text-white px-3 py-1 rounded text-7xl"
      >
        ›
      </button>
    </div>
